...
def parse_and_load_bq(xml_content: bytes, data_type: str, business_date: str):
...
def fetch_upload_and_parse(url: str, blob_path: str, bucket, data_type: str, business_date: str):
